     ...
     >
        <div
         ...
         >
            ...
            <button
            className='hidden group-hover:flex items-center gap-2 text-xs text-blue-500 font-medium bg-blue-50 px-3 py-1 rounded text-nowrap border-blue-100 hover:border-blue-200 cursor-pointer absolute top-0 right-0'
            onClick={(e) => {
                e.stopPropagation();
                onDelete();
            }}>
